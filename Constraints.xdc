...
set_property -dict {PACKAGE_PIN A3 IOSTANDARD LVCMOS33} [get_ports {PIXEL_2_SCREEN[0]}]
set_property -dict {PACKAGE_PIN B4 IOSTANDARD LVCMOS33} [get_ports {PIXEL_2_SCREEN[1]}]
set_property -dict {PACKAGE_PIN C5 IOSTANDARD LVCMOS33} [get_ports {PIXEL_2_SCREEN[2]}]
set_property -dict {PACKAGE_PIN A4 IOSTANDARD LVCMOS33} [get_ports {PIXEL_2_SCREEN[3]}]

set_property -dict {PACKAGE_PIN C6 IOSTANDARD LVCMOS33} [get_ports {PIXEL_2_SCREEN[4]}]
set_property -dict {PACKAGE_PIN A5 IOSTANDARD LVCMOS33} [get_ports {PIXEL_2_SCREEN[5]}]
set_property -dict {PACKAGE_PIN B6 IOSTANDARD LVCMOS33} [get_ports {PIXEL_2_SCREEN[6]}]
set_property -dict {PACKAGE_PIN A6 IOSTANDARD LVCMOS33} [get_ports {PIXEL_2_SCREEN[7]}]

set_property -dict {PACKAGE_PIN B7 IOSTANDARD LVCMOS33} [get_ports {PIXEL_2_SCREEN[8]}]
set_property -dict {PACKAGE_PIN C7 IOSTANDARD LVCMOS33} [get_ports {PIXEL_2_SCREEN[9]}]
set_property -dict {PACKAGE_PIN D7 IOSTANDARD LVCMOS33} [get_ports {PIXEL_2_SCREEN[10]}]
set_property -dict {PACKAGE_PIN D8 IOSTANDARD LVCMOS33} [get_ports {PIXEL_2_SCREEN[11]}]
...
set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets -of_objects [get_cells Ball/*]];